package cn.lcy.knowledge.analysis.dictionary.util;
...
import cn.lcy.knowledge.analysis.dictionary.dao.DictionaryDAOI;
import cn.lcy.knowledge.analysis.dictionary.dao.DictionaryDAOImpl;
import cn.lcy.knowledge.analysis.enums.OntologyClassEnum;
import cn.lcy.knowledge.analysis.util.FileIOUtil;

public class IndividualsDictUtil {
	
	@SuppressWarnings( value = "unused" )
    private static final Logger log = LoggerFactory.getLogger( IndividualsDictUtil.class );
    
    public static final String CUSTOMDICTDIR = "/home/yue/ProjectsData/DeepSearch/HanLP/DataAndModel/data/dictionary/custom/";
